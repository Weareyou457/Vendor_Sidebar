  ...
  return (
    <div className="maindashboard">
      ...
      <div className="dashbox ">
        ...
        <h4 style={{ fontFamily: "initial", marginTop: '11px',marginLeft:'13px' }}>

          Select Type of Ad
        </h4>
        <br />
        <FormControl sx={{ width: "-webkit-fill-available;" }} className="mx-2 mb-4">
        ...
        <br />
        <h6 className="mx-2 mb-2" style={{ fontFamily: "initial" }}>
          Start Date:-
        </h6>{" "}
        <TextField
        ...
        <br />
        <Button
          style={{ backgroundColor: "red", position:'absolute',left:'50%',transform:'translateX(-50%)', width:'200px', height:'45px' }}
          variant="contained"
          // fullWidth
